...
function generateActionsEnum(actionsArray) {
  return actionsArray.reduce(function (actions, action) {
    return (actions[action.replace('video-react/', '')] = action) && actions;
  }, {});
}
...
var Actions = generateActionsEnum([LOAD_START, CAN_PLAY, WAITING, CAN_PLAY_THROUGH, PLAYING, PLAY, PAUSE, END, SEEKING, SEEKED, SEEKING_TIME, END_SEEKING, DURATION_CHANGE, TIME_UPDATE, VOLUME_CHANGE, PROGRESS_CHANGE, RATE_CHANGE, SUSPEND, ABORT, EMPTIED, STALLED, LOADED_META_DATA, LOADED_DATA, RESIZE, ERROR]);
...
var Actions$1 = generateActionsEnum([OPERATE, FULLSCREEN_CHANGE, PLAYER_ACTIVATE, USER_ACTIVATE]);

var ActionCreators$1 = {
...
var playerActions = Object.freeze({
	...
	Actions: Actions$1,
	ActionCreators: ActionCreators$1,
	handleFullscreenChange: handleFullscreenChange,
	activate: activate,
	userActivate: userActivate,
	play: play,
...
var Player = function (_Component) {
  ...
  function Player(props, _ref) {
    ...
    _this.manager = new Manager(store);
...
exports.playerReducer = video;
exports.operationReducer = operation;
exports.VideoActions = Actions;
exports.VideoActionCreators = ActionCreators;
exports.PlayerActions = Actions$1;
exports.PlayerActionCreators = ActionCreators$1;
